  ...
  return (
    <div className="my-[150px] flex flex-col items-center gap-14">
      ...
      <div className="flex items-end gap-9">
        ...
        <div className="flex flex-col">
          <div className="flex justify-center items-center rounded-t-2xl w-[304px] bg-[linear-gradient(20deg,#4B2DBB_0%,#B5446B_100%)]">
            <span className="uppercase text-xs font-bold p-2">
              Recomendando
            </span>
          </div>
          <div className="p-[1.6px] bg-[linear-gradient(20deg,#4B2DBB_0%,#B5446B_100%)] rounded-b-2xl">
            <div className="w-full bg-background-secondary p-8 flex flex-col gap-7 rounded-b-2xl">
              <div className="flex flex-col">
                <span className="text-white font-bold text-2xl">Vitálicio</span>
